    ...
    internal static class SelfTest
    {
        public static int Run()
        {
            ...
            try
            {
                ...
                var doc = new DocumentModel { Number = "QT-2099-0001", Type = "عرض سعر", Currency = "USD", GlobalDiscountPercent = 10m };
                ...
                var json = Path.Combine(root, "data.json"); storage.ExportJson(json, loaded);
